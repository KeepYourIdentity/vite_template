...
export default function ErrorUI({ title = "Terjadi Kesalahan", message, rawError }: ErrorUIProps): ReactElement {
  /* TODO: implementasi semua class dengan state :dark 
      menjadi seperti yang sudah mengimplementasikannya 
   */
  ...
  return (
    <div
      className={`flex-1 min-h-0 xy-center flex-col p-4 ${isDarkTheme ? "bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-200" : "bg-gray-50 text-gray-800"}`}
    >
      <div className="max-w-2xl w-full bg-white dark:bg-gray-950 rounded-lg shadow-md p-6 sm:p-8 border-t-4 border-red-500">
        ...
        /* 
         ...
         ?     (
         ?      tombol dummy, nanti containernya kubuatkan
         ?     ),
              kembali kehalaman login, atau mencoba mengirimkan log error
              dari useMemo diatas secara otomatis ke server atau secara manual 
              dengan mengirimkannya ke pengembang
         *     (
         *      untuk keamanan pengiriman secara manual akan dipikirkan nanti
         *      yang penting bisa dulu
         *     )
              NOTE: anda bisa merubah blok untuk tampilan ini agar jadi menarik !
         */
          <div className="bg-gray-100 dark:bg-gray-800 rounded-md p-4">
            <strong className="block text-sm text-gray-700 dark:text-gray-300 mb-2 uppercase tracking-wide">
